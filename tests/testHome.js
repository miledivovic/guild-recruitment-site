...
var homeUrl = 'http://i6.cims.nyu.edu:15090/home';
page.open(homeUrl);
var testsPassed = 0;
var testsFailed = 0;
page.onLoadFinished = function(status) {
	...
	if (title.innerHTML === 'Welcome to Shattered Expectations') {
		console.log('Home title checked. Pass');
		testsPassed++;
	} else {
		console.log('Home title checked. Fail');
		testsFailed++;
	}
